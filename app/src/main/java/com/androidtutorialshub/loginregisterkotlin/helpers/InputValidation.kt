...
(private val context: Context) {
     ...
     * @return
     */
    fun isInputEditTextFilled(editEmailAddress: EditText, textInputLayout: TextInputLayout, message: String): Boolean {

        val value = editEmailAddress.text.toString().trim()
        if (value.isEmpty()) {
            textInputLayout.error = message
            hideKeyboardFrom(editEmailAddress)
            return false
        } else {
     ...
     * @return
     */
    fun isInputEditTextEmail(editEmailAddress: EditText, textInputLayout: TextInputLayout, message: String): Boolean {
        val value = editEmailAddress.text.toString().trim()
